...
public class SwaggerConfig {
    ...
    @Value("${solidpay.swagger.contact.name}")
    private String name;

    @Value("${solidpay.swagger.contact.email}")
    private String email;

    @Value("${solidpay.swagger.contact.url}")
    private String url;
    ...
    public OpenAPI openAPI(){
        ...
        .title("solidpay")
        .description("solidpay is a mobile recharge application.")
        .version("1.0.0")
        .contact(new Contact()
                .name(name)
                .email(email)
