...
{/* </div> */}
   <div className='w-screen h-screen flex bg-white p-6 md:p-10 lg:px-44 '>
    ...
    <div className='hidden md:flex flex-col w-1/2 h-full bg-cyan-500 rounded-l-[50px] shadow-2xl border-black'>
      ...
      <div className='  md:w-2/3 md:flex-col  ml-20 mt-16 justify-center items-center h-1/2'>
          <span>
            <h3 className='text-s3 font-bold md:text-3xl'>Top up effortlessly with solidpay - your ultimate recharge companion!</h3>
          </span>
          <span>
...
instantly & all with a tap!
    ...
    <div className='md:flex md:flex-col md:w-1/2 md:h-full bg-white md:rounded-r-[50px] md:rounded-none 
     sm:rounded-2xl w-full shadow-2xl md:p-[10px] lg:p-[50px] pb-[30px] justify-between  rounded-3xl' >
           ...
           <h1 className='md:hidden mt-10 block text-3xl font-bold text-teal-400 text-center'>SolidPay</h1>
      {
        !user ?(
          ...
          {/* <p className='md:text-sm lg:text-lg md:mb-0 mb-10'>Top up effortlessly with SolidPay - your ultimate recharge companion!</p>
           */}
...
{/* //otp */}
          ...
          <div className='h-[1px]  md:my-5 bg-gray-400 flex justify-center items-center  mx-10'></div>
            ...
            <div className=''>
              <h1 className='font-semibold text-center'> Been here before? Dive back in!<Link to={"/solidpay/login"}><span className='text-teal-400'> Log in now.</span></Link></h1>
            </div>
            </div>
